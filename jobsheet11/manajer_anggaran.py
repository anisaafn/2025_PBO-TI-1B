...
class AnggaranHarian:
    ...
    # --- KODE BARU DITAMBAHKAN SESUAI PENUGASAN ---
    ...
    # --- METODE INI DIMODIFIKASI UNTUK MENAMBAHKAN 'id' ---
    def get_dataframe_transaksi(self, filter_tanggal: datetime.date | None = None) -> pd.DataFrame:
        # Query diubah untuk menyertakan 'id' agar bisa ditampilkan di frontend
        ...
        if not df.empty:
              ...
              # Urutan kolom diubah untuk menampilkan 'id' di awal
